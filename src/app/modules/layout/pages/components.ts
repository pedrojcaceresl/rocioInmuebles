...
export const components: RouteProps[] = [
  {
    ...
    href: 'propiedades/mis-propiedades',
    group: false,
  ...
  {
    title: 'Filtros',
    icon: `<svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white">
