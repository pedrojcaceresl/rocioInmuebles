  ...
  template: `
    <div>
      ...
      <div>
        ...
        <div class="flex mt-6 space-x-6" *ngIf="linkBrochure">
          <button
            (click)="openLink(linkBrochure)"
            class="bg-amarillo-rocio text-sm text-white font-bold px-6 py-2 rounded-lg"
          >
            Ver Brochure
          </button>
        </div>
...
export class DetailsComponent {
  ...
  openLink(linkBrochure: any) {
    window.open(linkBrochure, '_blank');
  }
}
